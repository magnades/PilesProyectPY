import numpy as np
import pandas as pd
from PruebaGenPilotes import generate_pilescoord, generate_links, generate_piles, calcular_coordenadas_placa, generate_frames, generate_slab
...
Shells = generate_slab(Coord, Ly, N)

print(Shells)

# Impresión de datos de pilotes
pd.DataFrame(Shells).to_excel("Datos.xlsx")